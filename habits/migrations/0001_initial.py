# Generated by Django 4.2.5 on 2024-03-10 08:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('week', 'ежедневно'), ('day', 'еженедельно')], default='day', max_length=15, verbose_name='Переодичность')),
                ('reward', models.CharField(blank=True, max_length=255, null=True, verbose_name='Вознаграждение')),
                ('duration', models.PositiveIntegerField(help_text='Не больше 120 секунд', verbose_name='Время на выполнение')),
